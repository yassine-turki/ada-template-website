...
<div style="display: flex; justify-content: center; align-items: center;">
    <figure id="Female_actors_ratio" style="margin-right: 20px; text-align: left; width: 800px; height: 500px; margin-top: -50px;">
...
<div style="display: flex; justify-content: center; align-items: center;">
    <figure id="Proportion_of_revenues_with_animation" style="margin-right: 20px; text-align: left; width: 800px; height: 500px;">
