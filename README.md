...
<div style="display: flex; justify-content: center; align-items: center; overflow: hidden;">
    <figure id="Female_actors_ratio" style="margin-right: 20px; text-align: left; width: 100%; max-width: 1000px; max-height: 600px;">
        <iframe src="figs/Female_actors_ratio.html" style="width: 100%; height: 100%; border: none;" frameborder="0"></iframe>
    </figure>
</div>
